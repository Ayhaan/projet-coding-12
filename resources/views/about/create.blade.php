                            ...
                            <form  action="/about"  method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div  class="form-group mb-4">
                                        ...
                                        <input  type="text" class="form-control"  name="name"  id=""  placeholder="Nom && Prénom">
                                    </div>      
                                    <div  class=" mb-4 d-flex flex-column">
                                        ...
                                        <textarea class="form-control" id="hello" name="description"  cols="50" rows="4" placeholder="description"></textarea>
                                    </div>     
                                    <div  class="form-group mb-4">
                                        ...
                                        <textarea class="form-control" id="hello" name="descriptionSecondary"  cols="50" rows="4" placeholder="Description du poste"></textarea>

                                    </div>    
                                    <div class="row">
                                        <div  class="form-group mb-4 col-6">
                                            <label  for="">Facebook</label>
                                            <input  type="text" class="form-control" name="facebook"  id=""  placeholder="facebook">
                                        </div>
                                        <div  class="form-group mb-4 col-6">
                                            <label  for="">Twitter</label>
                                            <input  type="text" class="form-control"name="twitter"  id=""  placeholder="twitter">
                                        </div>
                                        <div  class="form-group mb-4 col-6">
                                            <label  for="">Dribbble</label>
                                            <input  type="text" class="form-control"name="dribbble"  id=""  placeholder="dribbble">
                                        </div>
                                        <div  class="form-group mb-4 col-6">
                                            <label  for="">Pinterest</label>
                                            <input  type="text" class="form-control"name="pinterest"  id=""  placeholder="pinterest">
                                        </div>
